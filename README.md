...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/kaikwanlau/efficient-score-embedding-single-image.git](https://github.com/kaikwanlau/efficient-score-embedding-single-image.git)
